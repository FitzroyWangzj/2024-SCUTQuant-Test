...
我们自己录制了一个配置视频，但由于云电脑网速慢且暂未剪辑，可能需要快进或倍速，相关资料链接（sscutquant-2024-2025-file -> install.mkv以及 2-Anaconda+Jupyter+VScode配置 文件夹）：
通过百度网盘分享的文件：scutquant-2024-2025-file
链接：https://pan.baidu.com/s/15l8pqbliYorUT7j9IBh-GQ?pwd=fgyz 
提取码：fgyz 
--来自百度网盘超级会员V3的分享
